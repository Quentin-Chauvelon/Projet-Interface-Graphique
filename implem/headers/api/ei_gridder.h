/**
 *  @file	ei_gridder.h
 *  @brief	API for using the gridder. Defines functions to manage the positioning
 *          and sizing of widgets on the screen in a grid
 *
 *  \author
...
#ifndef EI_GRIDDER_API_H
#define EI_GRIDDER_API_H
